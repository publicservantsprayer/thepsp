...
>(({ className, children, ...props }, ref) => {
  ...
  // Disable click on trigger when menu is first opened
  React.useEffect(() => {
    ...
    const element = targetRef?.current as unknown as Node
    if (element) {
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      // TODO: Fix typescript issue
      ref={targetRef as unknown as ForwardedRef<HTMLButtonElement>}
      // ref={ref}
      // Add element to ref array ////////////////////////////////
      // ref={(ref) => (targetRef.current[0] = ref)}
      // Prevent clicks while disabled
      onClick={(e) => {
        if (disable) {
          e.preventDefault()
        }
